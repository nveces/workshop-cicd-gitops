...
Check the versions of the tools installed on your laptop using the following commands, for example:
...
- A set of GitHub repositories that include the templates and automatisms required to deploy a group of applications
  - https://github.com/acidonper/jump-app-gitops[GitHub - Jump App GitOps Repository,window=_blank]
  - https://github.com/acidonper/jump-app-helm-charts[GitHub - Jump App Helm Charts,window=_blank]
...
| <ocp_cluster_console>
| _https://console-openshift-console.apps.cicdgitopsworkshop.sandbox507.opentlc.com[window=_blank]_
| Username
| <username>
| `userXX`
| Password
...
- <ocp_cluster_console> (_E.g. https://console-openshift-console.apps.cicdgitopsworkshop.sandbox507.opentlc.com[window=_blank]_)
