...
* Move `Chart.yaml.cicd` to `Chart.yaml`:

[source]
----
$ git mv Chart.yaml.cicd Chart.yaml
----
...
* Move `values.yaml.cicd` to `values.yaml`:

[source]
----
$ git mv values.yaml.cicd values.yaml
----

* Edit the `values.yaml` file. Modify:
