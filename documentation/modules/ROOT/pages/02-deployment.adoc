...
** and _global.appsDomain_ - It's the *<openshift_apps_domain>* parameter. +
...
* Move `Chart.yaml.master` to `Chart.yaml`:

[source]
----
$ git mv Chart.yaml.master Chart.yaml
----
...
* Move `values.yaml.master` to `values.yaml`:

[source]
----
$ git mv values.yaml.master values.yaml
----
