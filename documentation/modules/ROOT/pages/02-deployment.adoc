...
image::github_acidonper.png[link=assets/images/github_acidonper.png,window=_blank]

* Fork the repository

.Acidonper GitOps Repository Fork
image::github_gitops_fork.png[link=assets/images/github_gitops_fork.png,window=_blank]

.Acidonper GitOps Repository Forked
image::github_gitops_forked.png[link=assets/images/github_gitops_forked.png,window=_blank]
...
image::github_gitops_cloned.png[link=assets/images/github_gitops_cloned.png,window=_blank]
...
* Edit the `Chart.yaml` file. Modify:
...
* Create `values.yaml` file modifying:
...
** and _global.appsDomain_ with *<username>* ,
...
----
 ...
 and *<openshift_apps_domain>* parameters value respectively provided by the instructor:
...
[source,input,subs="+macros,+attributes"]
----
git mv Chart.yaml.dep Chart.yaml
git mv values.yaml.dep values.yaml
git commit -m "Added Chart.yaml and values.yaml files"
git push origin cicd
----
